...
public class CodeService {
    ...
    @Autowired
    public CodeService(Executor asyncExecutor, CacheService cacheService, CashCustomerService cashCustomerService, CodeRepository codeRepository, QrShopRepository qrShopService) {
    ...
    ResponseSuccess cancleCode(String qrid, HttpServletRequest request) throws BadRequestException, SQLException {
        Customer staffDataToken = (Customer) request.getAttribute("customerDataToken");
        String uid = staffDataToken.getUid();
